...
# read files
seq <- readDNAStringSet("data-generation/03b_france_wnv_filter.fasta")

# sequences to remove based on TempEst analysis of the seq dataset
remove_seq <- c("PP482824_2023-07-25")
...
# save the output
writeXStringSet(filtered_seq, "data-generation/03c_france_wnv_filter.fasta")
